        ...
        {DEPOSIT_TABS.map((tab) => {
          ...
          return (
            <button
              ...
              className={[
                "relative flex h-10 min-w-[62px] cursor-pointer items-center justify-center rounded-lg px-3.5 text-[13px] font-medium transition-colors disabled:cursor-default",
                active ? "text-zinc-100" : "text-zinc-300 hover:text-zinc-100",
              ].join(" ")}
            >
              {active ? (
                <motion.span
                  layoutId="deposits-segment-active"
                  transition={{
                    type: "spring",
                    stiffness: 420,
                    damping: 34,
