...
export default function AppSidebar() {
  ...
  return (
    <>
      ...
      <nav className="fixed inset-x-0 bottom-0 z-50 border-t mask-t-from-[75%] border-zinc-800 bg-[#09090b]/95 pb-[env(safe-area-inset-bottom)] backdrop-blur md:hidden">
