...
const ACCOUNT_CARD_CLASS =
  "group min-h-[86px] w-full rounded-[14px] border border-zinc-900 bg-zinc-950 px-4 py-3 transition-colors hover:border-zinc-700 sm:shrink-0 sm:snap-start sm:snap-always";
