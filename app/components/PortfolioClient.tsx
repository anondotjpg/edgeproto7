...
function MobileValueGrid({
  ...
  return (
    <div className="mt-3 flex justify-end pl-[58px]">
      <div className="grid w-full max-w-[274px] grid-cols-[minmax(0,0.75fr)_minmax(0,0.75fr)_minmax(96px,1.15fr)] gap-2.5 text-right">
        <div>
          <div className="ml-auto h-3.5 truncate text-[15px] font-semibold capitalize leading-[14px] text-zinc-600">
            Status
          </div>
        ...
        <div>
          <div className="ml-auto h-3.5 truncate text-[15px] font-semibold capitalize leading-[14px] text-zinc-600 overflow-visible">
            {resultLabel}
          </div>
          <div
            className={[
